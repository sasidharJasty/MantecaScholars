# Generated by Django 4.2.30 on 2026-08-26 00:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('program', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='chat_rooms', to='api.program')),
            ],
        ),
        migrations.CreateModel(
            name='ChatMessage',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('program', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rosters', to='api.program')),
